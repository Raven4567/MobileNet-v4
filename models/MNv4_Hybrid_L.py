...
from modules import Stem, FusedIB, ExtraDW, ConvNext, MobileMQA

# The model for 384x384 ImageNet-1k classification
class MNv4_Hybrid_L(nn.Module):
    def __init__(self):
        super().__init__()
        ...
        self.model = nn.Sequential(
            ...
            nn.Sequential(
                ...
                ExtraDW(96, 96, 384, kernel_size_1st=(3, 3), kernel_size_2nd=(3, 3), stride=1, padding_1st=1, padding_2nd=1)
            ),
            nn.Sequential(
                ExtraDW(96, 192, 768, kernel_size_1st=(3, 3), kernel_size_2nd=(5, 5), stride=2, padding_1st=1, padding_2nd=2),
                ExtraDW(192, 192, 768, kernel_size_1st=(3, 3), kernel_size_2nd=(3, 3), stride=1, padding_1st=1, padding_2nd=1),
                ExtraDW(192, 192, 768, kernel_size_1st=(3, 3), kernel_size_2nd=(3, 3), stride=1, padding_1st=1, padding_2nd=1),
                ExtraDW(192, 192, 768, kernel_size_1st=(3, 3), kernel_size_2nd=(3, 3), stride=1, padding_1st=1, padding_2nd=1),
                ExtraDW(192, 192, 768, kernel_size_1st=(3, 3), kernel_size_2nd=(5, 5), stride=1, padding_1st=1, padding_2nd=2),
                ExtraDW(192, 192, 768, kernel_size_1st=(5, 5), kernel_size_2nd=(3, 3), stride=1, padding_1st=2, padding_2nd=1),
                ExtraDW(192, 192, 768, kernel_size_1st=(5, 5), kernel_size_2nd=(3, 3), stride=1, padding_1st=2, padding_2nd=1),
                MobileMQA(192, num_heads=4, downsample=True),
                ExtraDW(192, 192, 768, kernel_size_1st=(5, 5), kernel_size_2nd=(3, 3), stride=1, padding_1st=2, padding_2nd=1),
                MobileMQA(192, num_heads=4, downsample=True),
                ExtraDW(192, 192, 768, kernel_size_1st=(5, 5), kernel_size_2nd=(3, 3), stride=1, padding_1st=2, padding_2nd=1),
                MobileMQA(192, num_heads=4, downsample=True),
            ...
            nn.Sequential(
                ExtraDW(192, 512, 2048, kernel_size_1st=(5, 5), kernel_size_2nd=(5, 5), stride=2, padding_1st=2, padding_2nd=2),
                ...
                ConvNext(512, 512, 2048, kernel_size=(5, 5), stride=1, padding=2),
                ExtraDW(512, 512, 2048, kernel_size_1st=(5, 5), kernel_size_2nd=(3, 3), stride=1, padding_1st=2, padding_2nd=1),
                MobileMQA(512, num_heads=4, downsample=True),
                ConvNext(512, 512, 2048, kernel_size=(5, 5), stride=1, padding=2),
                MobileMQA(512,num_heads=4, downsample=True),
                ConvNext(512, 512, 2048, kernel_size=(5, 5), stride=1, padding=2),
                MobileMQA(512,num_heads=4, downsample=True),
