...
from modules import Stem, ExtraDW, FusedIB, ConvNext, FFN, MobileMQA

# The model for 256x256 ImageNet-1k classification
class MNv4_Hybrid_M(nn.Module):
    def __init__(self):
        super().__init__()
        ...
        self.model = nn.Sequential(
            ...
            nn.Sequential(
                ...
                ExtraDW(80, 80, 160, kernel_size_1st=(3, 3), kernel_size_2nd=(3, 3), stride=1, padding_1st=1, padding_2nd=2)
            ),
            nn.Sequential(
                ...
                ExtraDW(160, 160, 640, kernel_size_1st=(3, 3), kernel_size_2nd=(3, 3), stride=1, padding_1st=1, padding_2nd=1),
                ExtraDW(160, 160, 640, kernel_size_1st=(3, 3), kernel_size_2nd=(5, 5), stride=1, padding_1st=1, padding_2nd=2),
                MobileMQA(160, num_heads=4, downsample=True),
                ExtraDW(160, 160, 640, kernel_size_1st=(3, 3), kernel_size_2nd=(3, 3), stride=1, padding_1st=1, padding_2nd=1),
                MobileMQA(160, num_heads=4, downsample=True),
            ...
            nn.Sequential(
                ...
                ExtraDW(256, 256, 512, kernel_size_1st=(3, 3), kernel_size_2nd=(5, 5), stride=1, padding_1st=1, padding_2nd=2),
                MobileMQA(256, num_heads=4),
                ExtraDW(256, 256, 1024, kernel_size_1st=(5, 5), kernel_size_2nd=(5, 5), stride=1, padding_1st=2, padding_2nd=2),
                MobileMQA(256, num_heads=4),
                FFN(256, 256, 1024),
                MobileMQA(256, num_heads=4),
                FFN(256, 256, 1024),
                MobileMQA(256, num_heads=4),
                ConvNext(256, 256, 1024, kernel_size=(5, 5), stride=1, padding=2),
            ),
            nn.Sequential(
